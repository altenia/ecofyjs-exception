 ...
 *     cause:   (!Exception | Error), // The cause of this exeption
 *     statusCode:  (!number), // The HTTP status code that classifies this exception
 *     messageCode  - the message code for l10n
 *     context: {
 *         domain: (!string),
 *     },
 ...
 * }}
 *
 * To create an exception, use new opearator, e.g. new Exception(..).
 * To create an exception wrapping an existing error or exception, use 
 * Exception.wrapError. E.g. var ex = Exception.wrapError(error).
 * To create an error for HTTP status, use helper static functions
 * E.g. Exception.createBadRequestError(cause, context);
 *
 * **************************************************************************/
 ...
 * @param {Exception | Error | undefined} cause  - The cause of this exeption
...
internals.Exception.createStandardError = function(name, message, cause, statusCode, context)
{
    var exception;
    if (cause) {
        internals.Exception.wrapError(cause,
            name, 
            message, 
            statusCode,
            name
        ...
        exception = new internals.Exception(name, message, null, statusCode, null, context);
    }
 ...
 */
internals.Exception.createBadRequestError = function(cause, context, customMessage)
{
    return internals.Exception.createStandardError(
        'BadRequest', 
        customMessage || 'Bad Request Error', 
        cause,
        400, context
    );
};
 ...
 */
internals.Exception.createUnauthorizedError = function(cause, context, customMessage)
{
    return internals.Exception.createStandardError(
        'Unauthorized', 
        customMessage || 'Unauthorized Error', 
        cause,
        401, context
    );
};
 ...
 */
internals.Exception.createForbiddenError = function(cause, context, customMessage)
{
    return internals.Exception.createStandardError(
        'Forbidden', 
        customMessage || 'Forbidden Error', 
        cause,
        403, context
    );
};
 ...
 */
internals.Exception.createNotFoundError = function(cause, context, customMessage)
{
    return internals.Exception.createStandardError(
        'NotFound', 
        customMessage || 'Not Found Error', 
        cause,
        404, context
    );
};
 ...
 */
internals.Exception.createInternalServerError = function(cause, context, customMessage)
{
    return internals.Exception.createStandardError(
        'InternalServerError', 
 ...
 */
internals.Exception.createNotImplementedError = function(cause, context, customMessage)
{
    return internals.Exception.createStandardError(
        'NotImplemented', 
        customMessage || 'Not Implemented Error', 
        cause,
        501, context
    );
};
